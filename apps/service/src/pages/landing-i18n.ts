...
const en = {
  ...
  mock_label: 'Example of a mail sent with Lumitra Mail',
...
const de: LandingMessages = {
  ...
  mock_label: 'Beispiel einer Mail, die mit Lumitra Mail verschickt wurde',
  ...
  paths_title: 'Zwei Wege hinein',
  app_title: 'Sie haben eine App',
  app_text:
    'Ihre App behält ihre Nutzer, Lumitra Mail kümmert sich um die Mails. Senden Sie und gleichen Sie Kontakte über die REST-API oder das TypeScript-SDK ab, und bekommen Sie signierte Webhooks zurück, wenn eine Mail rausgeht, fehlschlägt, zurückkommt oder sich jemand abmeldet.',
...
const it: LandingMessages = {
  ...
  mock_label: 'Esempio di una mail inviata con Lumitra Mail',
...
const fr: LandingMessages = {
  ...
  mock_label: 'Exemple d’un e-mail envoyé avec Lumitra Mail',
...
const es: LandingMessages = {
  ...
  mock_label: 'Ejemplo de un correo enviado con Lumitra Mail',
